...
// module
exports.push([module.i, "* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0; }\n\nbody {\n  color: #000;\n  font-family: \"Avenir\", Helvetica, sans-serif;\n  max-width: 450px;\n  margin: 0 auto;\n  position: relative; }\n  body.show {\n    overflow: hidden; }\n\nh1,\nh2,\nh3 {\n  margin: 0; }\n\nimg {\n  width: 100%;\n  display: block; }\n\na {\n  color: #000;\n  text-decoration: none; }\n\nul {\n  list-style-type: none; }\n\n/* FLEX BOX / prefixes */\n.container {\n  display: -webkit-box;\n  display: -moz-box;\n  display: -ms-flexbox;\n  display: -webkit-flex;\n  display: flex; }\n\n.column {\n  flex-direction: column; }\n\n.shadow-color:hover {\n  box-shadow: 1px 5px 1em 1px #f2a648; }\n\n.shadow {\n  box-shadow: 1px 2px 9px -1px #8c8c8c; }\n\n.shadow-light {\n  box-shadow: 1px 2px 9px -1px lightgray; }\n\n.gradient {\n  background-image: linear-gradient(to top right, #ff6200, #ffb06b); }\n\n.gradient-blue {\n  background-image: linear-gradient(to top right, #005f74, #00479d); }\n\n.gradient-green {\n  background-image: linear-gradient(to top right, #1da362, #7bfebf); }\n\n.btn {\n  border: none;\n  border-radius: 5px;\n  height: 45px;\n  margin: 2px;\n  background: #fff;\n  color: #000;\n  font-size: 20px;\n  cursor: pointer; }\n  .btn.primary-button, .btn.invert-button {\n    color: #fff;\n    background-image: linear-gradient(to top right, #ff6200, #f2a648); }\n    .btn.primary-button:hover, .btn.invert-button:hover, .btn.primary-button:focus, .btn.invert-button:focus {\n      background: #ff6200; }\n  .btn.secondary-button {\n    border: 2px solid #f2a648;\n    color: #f2a648; }\n    .btn.secondary-button:hover, .btn.secondary-button:focus {\n      color: #ff6200;\n      border: 2px solid #ff6200; }\n  .btn.invert-button {\n    border: 2px solid white; }\n    .btn.invert-button:hover, .btn.invert-button:focus {\n      color: #ff6200;\n      background-color: #fff;\n      border: 2px solid #ff6200; }\n\n.btn-container {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr); }\n\n.footer {\n  justify-content: center;\n  align-items: center;\n  background: #323234;\n  color: #fff;\n  font-size: 12px;\n  padding: 15px; }\n\n.info-list {\n  justify-content: center;\n  flex-wrap: wrap; }\n  .info-list .info-item {\n    padding: 8px;\n    margin: 5px;\n    height: 40px;\n    border-radius: 20px;\n    background: #e4e4e4;\n    display: grid;\n    align-items: center; }\n\n.big-space {\n  margin-bottom: 1.5em; }\n\n.small-space {\n  margin-bottom: 1em; }\n\n.small-padding {\n  padding: 5px 15px; }\n\nheader {\n  position: fixed;\n  z-index: 3;\n  width: 100%; }\n  header.show::after {\n    content: '';\n    display: block;\n    background-color: rgba(0, 0, 0, 0.8);\n    height: 100vh;\n    max-width: 450px;\n    opacity: 1; }\n\n.menu-btn-container {\n  position: absolute;\n  top: 20px;\n  left: 20px;\n  width: 50px;\n  height: 50px;\n  border-radius: 50%; }\n  .menu-btn-container.close {\n    background: none;\n    z-index: 4; }\n\n.menu-btn {\n  position: absolute;\n  right: 11px;\n  top: 16px;\n  cursor: pointer;\n  transition: all 200ms ease-in-out; }\n  .menu-btn .btn-line {\n    width: 28px;\n    height: 3px;\n    margin: 0 0 5px 0;\n    border-radius: 15px;\n    background: #fff;\n    transition: all 200ms ease-in-out; }\n  .menu-btn.close {\n    transform: rotate(180deg); }\n    .menu-btn.close .btn-line {\n      background: #fff; }\n      .menu-btn.close .btn-line:nth-child(1) {\n        transform: rotate(45deg) translate(5px, 5px); }\n      .menu-btn.close .btn-line:nth-child(2) {\n        opacity: 0; }\n      .menu-btn.close .btn-line:nth-child(3) {\n        transform: rotate(-45deg) translate(7px, -6px); }\n\n.menu {\n  position: relative;\n  visibility: hidden; }\n  .menu.show {\n    visibility: visible; }\n  .menu-nav {\n    display: flex;\n    flex-flow: column wrap;\n    position: absolute;\n    width: 270px;\n    height: 100vh;\n    top: 0;\n    left: -270px;\n    overflow: hidden;\n    padding-top: 85px;\n    transition: all 200ms ease-in-out; }\n    .menu-nav.show {\n      left: 0; }\n  .menu .menu-nav-items {\n    display: inline-block;\n    padding: 0.8rem 35px;\n    font-size: 15px;\n    font-weight: 500;\n    color: #fff;\n    text-decoration: none;\n    transition: all 200ms ease-in-out; }\n    .menu .menu-nav-items:hover {\n      background: #e4e4e4;\n      color: #000; }\n\n.hero-img-container {\n  width: 100%;\n  justify-content: center; }\n  .hero-img-container .hero-img {\n    max-width: 250px;\n    object-fit: contain; }\n\n.hero-info .hero-title {\n  justify-content: center; }\n  .hero-info .hero-title h1 {\n    padding: 5px 0;\n    font-size: 1.8em; }\n\n.hero-info .primary-button, .hero-info .btn.invert-button,\n.hero-info .secondary-button {\n  align-items: center;\n  justify-content: center; }\n\n.hero-info p {\n  padding: 20px; }\n\n.roles-container .roles-list {\n  justify-content: center;\n  background: #e4e4e4; }\n  .roles-container .roles-list .role-item {\n    padding: 10px;\n    border-radius: 10px;\n    background: #fff;\n    margin: 20px 20px 0; }\n    .roles-container .roles-list .role-item:last-of-type {\n      margin-bottom: 20px; }\n    .roles-container .roles-list .role-item .role-header {\n      margin-bottom: 10px; }\n    .roles-container .roles-list .role-item .read-more {\n      text-decoration: none;\n      color: #f2a648; }\n    .roles-container .roles-list .role-item .role-button {\n      width: 100%; }\n    .roles-container .roles-list .role-item a {\n      cursor: pointer; }\n      .roles-container .roles-list .role-item a:hover, .roles-container .roles-list .role-item a:focus {\n        color: #ff6200; }\n    .roles-container .roles-list .role-item .expander {\n      transition: all 200ms ease-in-out;\n      height: 0;\n      opacity: 0;\n      min-height: 0;\n      overflow: hidden;\n      margin-top: 0; }\n      .roles-container .roles-list .role-item .expander.show {\n        height: auto;\n        margin-top: 30px;\n        opacity: 1;\n        margin-bottom: 20px; }\n    .roles-container .roles-list .role-item ul {\n      list-style-type: disc; }\n      .roles-container .roles-list .role-item ul li {\n        margin-left: 34px; }\n\n.title {\n  margin-left: 15px; }\n\n.contact-container {\n  align-items: center;\n  justify-content: center;\n  margin: 15px;\n  padding: 15px;\n  border-radius: 10px; }\n  .contact-container .form-input-container {\n    position: relative;\n    width: 100%;\n    margin-bottom: 10px; }\n    .contact-container .form-input-container i {\n      position: absolute;\n      z-index: 0;\n      top: 12px;\n      left: 10px; }\n    .contact-container .form-input-container input,\n    .contact-container .form-input-container textarea {\n      position: relative;\n      border: none;\n      border-radius: 10px;\n      padding: 5px 5px 5px 35px;\n      width: 100%; }\n    .contact-container .form-input-container input {\n      height: 40px; }\n    .contact-container .form-input-container textarea {\n      resize: none;\n      padding-top: 12px; }\n  .contact-container button {\n    height: 40px;\n    width: 100%;\n    border-radius: 10px; }\n\n.team-container {\n  padding: 10px 10px 10px 20px; }\n  .team-container p {\n    color: #f2a648; }\n  .team-container .team-image {\n    width: 50px;\n    height: 50px;\n    border-radius: 50%;\n    filter: grayscale(1);\n    margin-right: 15px; }\n\n.modal-container {\n  position: fixed;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  z-index: 99;\n  background-color: rgba(0, 0, 0, 0.5);\n  width: 450px;\n  height: 100%;\n  visibility: hidden;\n  opacity: 0;\n  transition: all 200ms ease-in-out; }\n  .modal-container.show {\n    visibility: visible;\n    opacity: 1; }\n  .modal-container .modal {\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    height: auto;\n    width: 70%;\n    border-radius: 15px;\n    padding: 15px;\n    background-color: white;\n    overflow: hidden; }\n    .modal-container .modal button {\n      height: 30px;\n      margin-top: auto; }\n", ""]);
