...
// module
exports.push([module.i, ".menu-btn-container {\n  float: right;\n  position: absolute;\n  right: 35px;\n  top: 35px;\n  z-index: 2;\n  width: 50px;\n  height: 50px;\n  border-radius: 50%;\n  background: white; }\n  .menu-btn-container.close {\n    background: none; }\n\n.menu-btn {\n  position: absolute;\n  z-index: 3;\n  right: 11px;\n  top: 16px;\n  cursor: pointer;\n  transition: all 170ms ease-out; }\n  .menu-btn .btn-line {\n    width: 28px;\n    height: 3px;\n    margin: 0 0 5px 0;\n    background: #000;\n    transition: all 170ms ease-out; }\n  .menu-btn.close {\n    transform: rotate(180deg); }\n    .menu-btn.close .btn-line:nth-child(1) {\n      transform: rotate(45deg) translate(5px, 5px);\n      background: #000; }\n    .menu-btn.close .btn-line:nth-child(2) {\n      opacity: 0; }\n    .menu-btn.close .btn-line:nth-child(3) {\n      transform: rotate(-45deg) translate(7px, -6px);\n      background: #000; }\n\n.menu {\n  position: fixed;\n  top: 0;\n  width: 100%;\n  visibility: hidden; }\n  .menu.show {\n    visibility: visible; }\n  .menu-nav {\n    display: flex;\n    flex-flow: column wrap;\n    float: right;\n    width: 250px;\n    height: 100vh;\n    overflow: hidden;\n    margin: 0;\n    padding-top: 90px;\n    background: white;\n    list-style: none;\n    transform: translate3d(100vw, 0, 0);\n    transition: all 170ms ease-out; }\n    .menu-nav.show {\n      transform: translate3d(0, 0, 0); }\n  .menu .menu-nav-items {\n    display: inline-block;\n    position: relative;\n    font-size: 15px;\n    padding: 0.8rem 35px;\n    font-weight: 500;\n    color: #000;\n    text-decoration: none;\n    transition: all 170ms ease-out; }\n    .menu .menu-nav-items:hover {\n      background: lightgrey; }\n\n.main-wrapper {\n  display: grid;\n  grid-template-columns: 1fr;\n  grid-template-rows: 300px, repeat(3, 200px);\n  justify-items: center;\n  align-items: start; }\n  .main-wrapper .roles-container {\n    display: grid;\n    justify-items: center; }\n    .main-wrapper .roles-container .roles-list {\n      background: lightgray;\n      display: grid;\n      justify-items: center;\n      grid-gap: 20px;\n      padding: 20px 0; }\n      .main-wrapper .roles-container .roles-list .role-item {\n        background: white;\n        width: 90%;\n        padding: 10px; }\n        .main-wrapper .roles-container .roles-list .role-item .role-header {\n          display: grid;\n          grid-template-columns: repeat(2, 1fr);\n          margin-bottom: 10px; }\n          .main-wrapper .roles-container .roles-list .role-item .role-header button {\n            border: none;\n            border-radius: 5px;\n            background: #f2a648;\n            color: white; }\n        .main-wrapper .roles-container .roles-list .role-item .read-more {\n          text-decoration: none;\n          color: #f2a648; }\n  .main-wrapper img {\n    align-self: start;\n    width: 100%; }\n  .main-wrapper .project-info {\n    align-self: start;\n    display: grid; }\n    .main-wrapper .project-info .project-title {\n      display: grid;\n      justify-items: center;\n      background: black; }\n      .main-wrapper .project-info .project-title h1 {\n        padding: 5px 0;\n        color: white; }\n    .main-wrapper .project-info p {\n      padding: 20px; }\n    .main-wrapper .project-info .btn {\n      border: none;\n      border-radius: 5px;\n      height: 45px;\n      margin: 2px;\n      background: white;\n      color: white;\n      font-size: 20px; }\n      .main-wrapper .project-info .btn.primary-button {\n        background: #f2a648; }\n      .main-wrapper .project-info .btn.secondary-button {\n        border: 2px solid #f2a648;\n        color: #f2a648; }\n    .main-wrapper .project-info .btn-container {\n      display: grid;\n      grid-template-columns: repeat(2, 1fr); }\n  .main-wrapper .skills-container,\n  .main-wrapper .tech-container {\n    margin: 20px 0;\n    display: grid;\n    justify-items: center; }\n    .main-wrapper .skills-container .skills-list,\n    .main-wrapper .tech-container .skills-list {\n      list-style: none;\n      display: flex;\n      justify-content: center;\n      flex-wrap: wrap; }\n      .main-wrapper .skills-container .skills-list .skill-item,\n      .main-wrapper .tech-container .skills-list .skill-item {\n        padding: 8px;\n        margin: 2px;\n        height: 40px;\n        border-radius: 20px;\n        background: lightgray;\n        display: grid;\n        align-items: center; }\n  .main-wrapper .roles-list {\n    list-style: none; }\n\n.footer {\n  display: grid;\n  justify-items: center;\n  align-items: center; }\n\n* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0; }\n\nbody {\n  color: #000;\n  font-family: \"Segoe UI\", Tahoma, Geneva, Verdana, sans-serif;\n  max-width: 500px;\n  margin: 0 auto; }\n\nh1,\nh2,\nh3 {\n  margin: 0; }\n", ""]);
